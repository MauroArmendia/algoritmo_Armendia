...
def Agregar_Numero(Matriz_Listas):
    try:
        numFila = int(input(f"Ingresa a qué fila de la matriz desea agregar el número \nFilas disponibles: {len(Matriz_Listas)}\n"))
        num = int(input("Ingresa el número que desea agregar: "))
...
def Busqueda_Secuencial(Matriz_Listas):
    try:
        numFila = int(input(f"Ingresa a qué fila de la matriz desea usar para la búsqueda \nFilas disponibles: {len(Matriz_Listas)}\n"))
...
def Busqueda_Binaria(Matriz_Listas):
    try:
        ...
        if Matriz_Listas[numFila] == sorted(Matriz_Listas[numFila]):
            num = int(input("Ingresa qué número desea buscar: "))
            izquierda = 0
...
def Ordenamiento_Insercion(Matriz_Listas):
    try:
        numFila = int(input(f"Ingresa a qué fila de la matriz desea ordenar \nFilas disponibles: {len(Matriz_Listas)}\n"))
...
while True:
    try:
        ...
        print("Error: tiene que ingresar un número entre 1 y 8.")
